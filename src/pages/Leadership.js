...
const LEADERS = [
  ...
  },
  {
    ...
    bio: 'Leading strategic business expansion across Worldwide markets, Swati drives high-value partnerships in aerospace, defence, and industrial sectors. With exceptional precision in project execution and supply chain excellence, she ensures seamless coordination, reliability, and an uncompromising standard of customer satisfaction.',
...
const PHILOSOPHY = [
  ...
  { icon: '💬', title: 'Transparent Communication', desc: 'Honest, proactive communication with every Worldwide client — on lead times, quality updates, and project milestones.' },
  { icon: '🤝', title: 'Long-Term Customer Partnerships', desc: 'We build lasting relationships with Worldwide manufacturers, becoming a trusted precision supplier they return to repeatedly.' },
];
  ...
  return (
    <div className="page">
      <PageHero
        ...
        label="Our Team"
        title="Leadership"
        subtitle="Meet the people who lead Microcraft Engineering's manufacturing operations and worldwide business development."
      />
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <Reveal>
            ...
            <p className="sec-desc" style={{ marginBottom: '52px' }}>
              Two dedicated leaders — one driving precision manufacturing in India and one leading worldwide client partnerships.
            </p>
          </Reveal>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <Reveal>
            ...
            <p className="sec-desc lt" style={{ marginBottom: '52px' }}>
              The values that guide every decision our leadership team makes — from the production floor to worldwide client engagements.
            </p>
          </Reveal>
...
<Reveal delay={i * 0.1} key={p.title} style={{ height: '100%' }}>
      ...
      <Reveal delay={0.1}>
        <div className="cta-strip">
          ...
          <p>Reach out to our European or India team for a detailed quotation within 24 hours.</p>
